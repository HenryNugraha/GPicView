...
void main_win_init( MainWin*mw )
{
    ...
    // Make gpicview run at fullscreen
...
void on_prev( GtkWidget* btn, MainWin* mw )
{
    ...
    {
        // Disable wrapping around image list.
...
void on_about( GtkWidget* menu, MainWin* mw )
{
    ...
    gtk_about_dialog_set_comments ( (GtkAboutDialog*)about_dlg, _( "Modified version by Henry Nugraha\nRelease date: 2015-02-10\n\nLightweight image viewer from LXDE project" ) );
